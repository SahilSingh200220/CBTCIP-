...
class Game
{
    ...
    public boolean takeUserInput()
    {
        ...
        {
            System.out.println("Oops your number of attempts has been finished...Better luck next time..\n");
            return true;
        }
    }
    ...
    public boolean isCorrectGuess()
    {
        ...
        {
            System.out.println("Congratulations you guess the correct number " + systemInput + "in" +noOfGuesses  + "guesses");
